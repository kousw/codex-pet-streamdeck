...
- Screen Recording permission is not required for the default asset renderer. Users should grant it only to the generated `Codex Pet Capture` app when explicitly using the `capture-overlay` fallback.
